...
- `src/agent/self_prompter.js` — current "autonomy": while active, injects `You are self-prompting with the goal: '<static string>'...` every ~2s of idle. No goal generation, decomposition, or replanning. **Phase 1 replaces its usage.**
